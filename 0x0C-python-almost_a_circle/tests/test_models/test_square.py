...
class TestSquareMethods(unittest.TestCase):
    ...
    def test_new_square_2(self):
        """ Testing the new square with all attrs """
        new = Square(2, 5, 5, 4)
    ...
    def test_dict_to_json(self):
        """ Testing the Dictionary to JSON string """
        s1 = Square(2)
    ...
    def test_value_square(self):
        """ Testing the value passed to Square """
        with self.assertRaises(ValueError):
            s1 = Square(-1)
    ...
    def test_create_4(self):
        """ Testing the create method """
        dictionary = {'id': 98, 'size': 1, 'x': 4, 'y': 3}
        s1 = Rectangle.create(**dictionary)
        self.assertEqual(s1.id, 98)
        self.assertEqual(s1.size, 1)
